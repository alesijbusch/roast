...
$MESS["FIELDS_SETTINGS"] = "Настройки и валидация пользовательских свойств";
$MESS["PHONE_MASK"] = "Маска для поля PHONE (телефон)";
$MESS["PHONE_VALIDATION"] = "Валидация для поля PHONE (телефон)";
